...
-- Dumping data for table fcentro.caja_tmp: ~0 rows (approximately)
...
INSERT INTO `credito` (`id`, `cliente`, `usuario_caja`, `detalle_id`, `fecha_inicio`, `fecha_fin`, `entrega`, `interes`, `total_cuotas`, `total_con_interes`, `saldo`, `estado`) VALUES
	(1, 'Sara Miranda', 'admin', 31, '2021-08-02 07:46:51', '2021-10-02 07:46:51', 'Y', 0, 2, 650000, '', 'PENDIENTE');
...
INSERT INTO `cuotas` (`id`, `credito_id`, `numero`, `monto`, `fecha_a_pagar`, `fecha_pago`, `vencimiento`, `estado`) VALUES
	...
	(2, 1, '2', 325000, '2021-10-02', '2022-01-25', '2021-10-07', 'PAGADO');
...
INSERT INTO `detalle` (`id`, `factura`, `codigo`, `nombre`, `cantidad`, `valor`, `importe`, `iva`, `iva1`, `iva2`, `totalIva`, `total`, `tipo`, `fecha_ingreso`) VALUES
	...
	(32, '1024', '0123', 'Llaves Combinadas Black+Decker Pro 7pzs 15-22mm', '1', '110000', '110000', 0, 5238, 0, 5238, '760000', '', '2021-11-27 16:08:22'),
	(33, '1024', '10', 'Chapa', '1', '650000', '650000', 0, 30952, 0, 30952, '760000', '', '2021-11-27 16:08:22');
...
INSERT INTO `factura` (`factura`, `cajera`, `nombrecli`, `cedula`, `total`, `iva`, `fecha`, `estado`) VALUES
	...
	('1021', 'admin', 'diego valenzuwela', '123456', 660000, NULL, '2021-07-16 00:00:00', 'Anulado'),
	...
	('1024', 'admin', 'Cliente por Defecto', '', 760000, NULL, '2021-11-27 00:00:00', 's');
...
INSERT INTO `producto` (`cod`, `prov`, `cprov`, `nom`, `costo`, `mayor`, `venta`, `venta2`, `cantidad`, `minimo`, `seccion`, `fecha`, `estado`, `clase`, `iva`, `foto`) VALUES
	('0123', '0', NULL, 'Llaves Combinadas Black+Decker Pro 7pzs 15-22mm', '60000', NULL, '110000', '', '989', '2', '0', '2021-01-14 15:35:51', 's', NULL, '10', 'articulo/0123.jpg'),
	('10', '0', NULL, 'Chapa', '500000', NULL, '650000', '', '993', '2', '0', '2021-02-08 22:33:32', 's', NULL, '10', ''),
	('118', '0', NULL, 'coquito', '0', NULL, '10000', NULL, '41', '2', '0', '2021-07-15 22:54:22', 's', NULL, '10', ''),
...
INSERT INTO `temp` (`id`, `cod`, `nom`, `costo`, `cant`, `importe`, `existencia`, `iva`, `usu`) VALUES
	(2, '0123', 'Llaves Combinadas Black+Decker Pro 7pzs 15-22mm', '60000', '2', '120000', '989', 10, 'admin');
